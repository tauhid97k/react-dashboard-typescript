...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-1 whitespace-nowrap group rounded-lg text-base font-medium text-white tracking-wide transition-colors focus:outline-none focus:ring-2 ring-offset-2 dark:ring-offset-gray-900 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
